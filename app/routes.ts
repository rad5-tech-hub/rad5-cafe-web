...
export default [
  ...
  route("admin/manage-admins", "routes/admin-manage-admins.tsx"),
  route("admin/pin-changes", "routes/admin-pin-changes.tsx"),
  route("admin/audit-logs", "routes/audit-logs.tsx"),
  route("inventory", "routes/inventory.tsx"),
  route("analytics", "routes/analytics.tsx"),
  route("accounting/manual", "routes/manual-accounting.tsx"),
